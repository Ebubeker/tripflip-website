...
export function HotelAddModal({ open, onOpenChange, tripId, onSave }: HotelAddModalProps) {
  ...
  const onSubmit = async (data: AccommodationFormData) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(result.error || 'Failed to add accommodation')
      }
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new accommodation to your trip
            </DialogDescription>
          </DialogHeader>
          {FormContent}
        </DialogContent>
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="h-[90vh] overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Add Accommodation</SheetTitle>
          <SheetDescription>
            Add a new accommodation to your trip
          </SheetDescription>
        </SheetHeader>
